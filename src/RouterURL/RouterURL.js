    ...
    return (
      <div>
        <Switch>
          ...
          <Route
            exact
            path="/home/nhan-su-chinh-thuc"
            component={PesonnelContainer}
          />
          <Route
            exact
            path="/home/nhan-su-chinh-thuc/them"
            component={ModalCreate}
          />
          }/>
          <Route
            exact
            path="/home/nhan-su-chinh-thuc/chi-tiet/:id"
            component={Detail}
          />
          <Route
            exact
